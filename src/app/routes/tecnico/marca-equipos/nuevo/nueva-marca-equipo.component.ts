...
@Component({
  selector: 'app-nueva-marca-equipo',
  templateUrl: './nueva-marca-equipo.component.html',
  styleUrls: ['./nueva-marca-equipo.component.css']
})
export class NuevaMarcaEquipoComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<NuevaMarcaEquipoComponent>,
  ...
  saveClient(): void {
    ...
    this.inventarioEquiposService.guardarMarcaEquipo(marcaEquipo).subscribe({
      next: res => {
